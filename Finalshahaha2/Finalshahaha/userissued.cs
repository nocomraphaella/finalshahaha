...
{
    public partial class userissued : Form
    {
        ...
        private void userissued_Load(object sender, EventArgs e)
        {
            loaddata();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                connection.Open();
                string records = "SELECT ID, Name, Contact, Title, Author, Date, Status FROM issued WHERE Name LIKE CONCAT('%', @search, '%') OR Contact LIKE CONCAT('%', @search, '%') OR Title LIKE CONCAT('%', @search, '%') OR Author LIKE CONCAT('%', @search, '%') OR Date LIKE CONCAT('%', @search, '%') OR Status LIKE CONCAT('%', @search, '%') OR ID LIKE CONCAT('%', @search, '%') ";
                MySqlCommand command = new MySqlCommand(records, connection);
